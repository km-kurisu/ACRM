...
export default function MasterDataPage() {
  ...
  const filtered = query.trim()
    ? rows.filter((r) =>
        [r.creator_name, r.creator_username, r.email, r.niche, r.city, r.country, r.assigned_manager].some((v) =>
          ...
          <DialogContent className="glass-strong max-h-[85vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="grid gap-4">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="c-username">Creator Username</Label>
              ...
              <TableBody>
                {filtered.map((row) => (
                  <TableRow key={row.id} className="hover:bg-accent/40">
                    ...
                    <TableCell className="whitespace-nowrap text-muted-foreground">{row.creator_username || "—"}</TableCell>
